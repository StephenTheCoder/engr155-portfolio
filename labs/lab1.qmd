...
$$ f_{out} = \frac{f_{HSOSC}}{\text{max\_count}} = \dfrac{48000000}{5000000} = 2.4 \text{Hz} $$

Where $f_{out}$ is the desired output frequency, $f_{in}$ is the input frequency, and max_count is the maximum count value for the counter. The maximum count value was calculated to be 4,999,999 such that this equation works (as counter starts from 0).
